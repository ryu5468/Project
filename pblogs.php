  ...
  $myUser = $_SESSION['name'];
      ...
      <div class="container">
        <div class="navbar-header">
          <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">
			...
			<a class="navbar-brand" href="pblogs.php">VERSA Blog
    ...
    <div class="container">
	  ...
	  <br></br>
		...
		<form action="pblogs.php" method="post">
...
<?php 
  ...
  $conn = mysql_connect($servername, $username, $password) or die(mysql_error());
	...
	// Display data from blogs
	while ($record = mysql_fetch_array($myData)) 
	  {
		
		// For blogs made by user display posts with update and delete buttons
		...
		// Display blog posts made by other users
		else
		  {
		  echo "<form action=pblogs.php method=post>";
		  ...
		  echo "<tr><td>" . "<input type=hidden name=hidden value=" . $record['posts'] . " </td></tr>";		  
		  echo "<br>";
		  echo "<hr>";
		  echo "</form>";
		  }		
